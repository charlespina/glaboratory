...
function onMouseMove(event) {
    ...
    var x = Math.floor(mouseX * exp.solver.N);
    var y = Math.floor(mouseY * exp.solver.N);
    exp.solver.inject(x, y, 0.0, 50.0, dx*exp.solver.N, dy*exp.solver.N);
}
...
var exp = new Experiment("Tea Cup");

exp.initData = function() {
  this.solver.reset();
